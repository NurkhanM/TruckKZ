...
class BrandSelectFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        mHomeViewModel.getBrand()




        mHomeViewModel.myBrand.observe(viewLifecycleOwner) { user ->

            view.progressNewCreatePro.visibility = View.GONE

            val childrenList = ArrayList<Data>()

            user.body()?.data?.let { brandModels ->
                childrenList.addAll(brandModels)
                adapter.setData(brandModels)
            }
