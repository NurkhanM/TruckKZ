...
public final class ActivityFavoriteBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout containerFavorite;

  private ActivityFavoriteBinding(@NonNull ConstraintLayout rootView,
      @NonNull FrameLayout containerFavorite) {
    this.rootView = rootView;
    this.containerFavorite = containerFavorite;
  }
  ...
  public static ActivityFavoriteBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.containerFavorite;
      FrameLayout containerFavorite = ViewBindings.findChildViewById(rootView, id);
      if (containerFavorite == null) {
        break missingId;
      }

      return new ActivityFavoriteBinding((ConstraintLayout) rootView, containerFavorite);
    }
